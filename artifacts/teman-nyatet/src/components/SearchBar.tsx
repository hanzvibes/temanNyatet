  ...
  return (
    <div className={`relative flex items-center w-full ${className}`}>
      ...
      <input
        ...
        className="w-full bg-background rounded-full pl-12 pr-12 py-3.5 text-sm font-semibold focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/20 shadow-sm border border-border focus:border-primary/30 transition-all placeholder:text-muted-foreground/50"
      />
      {value && (
        <button
          type="button"
